    ...
    >
      ...
      >
        <el-button
          ...
          @click="gotoUrl('/contentManage/partyEducation/classicAdd',{menuId: $route.query.menuId})"
...
export default {
  ...
  methods: {
    ...
    update(row) {
      ...
      this.gotoUrl("/contentManage/partyEducation/classicAdd", row);
    },
    // 弹框关闭时的回调函数
    handleClose(done) {
      done();
    ...
    getData() {
      ...
      //   this.$store.dispatch("cases/getCaseList", config);
